...
- NO people, faces, characters, engineers, workers, or human figures.
  - Hands or gloves are allowed ONLY if explicitly relevant to inspection.
- NO abstract symbolism (no flowers, metaphors, or conceptual imagery).
- NO generic “industrial” scenes (factories, conveyor belts, fabrication shops).
...
- The “metaphor” must still be literal and grounded (e.g., visual contrast, not symbolism).

If unsure, choose realism over creativity.
